...
class CatRolesSeeder extends Seeder
{
    ...
    {
        $events=[
            ['crol_rol'=>'admin',                   'crol_gps'=>'todos',                            'crol_describe'=>'(Enrique) Persona no adscrita a un jardín o campus específico que administra el registro de usuarios administradores de jardín, así como el registro de campus y jardines.'],
            ['crol_rol'=>'webmaster',               'crol_gps'=>'',                                 'crol_describe'=>'(Enrique) Persona adscrita a un campus que alimenta la página pública de información del mismo.'],
            ['crol_rol'=>'admin-campus',            'crol_gps'=>'adminjardin',                      'crol_describe'=>'(Enrique) Persona adscrita a un campus que administra los usuarios y camellones del mismo'],
            ...
            ['crol_rol'=>'admin-colviva',           'crol_gps'=>'adminjardin,jardin,colviva',       'crol_describe'=>'(Vianney) Persona adscrita a un campus que administra los datos de ubicación de los ejemplares.'],
            ...
            ['crol_rol'=>'capturista-colviva',      'crol_gps'=>'jardin,colviva,amigo',             'crol_describe'=>'(Caro) Persona adscrita a un campus y que realiza el trabajo de campo para la digitalización de los ejemplares de la colección.'],
            ...
            ['crol_rol'=>'curador-cientifico',      'crol_gps'=>'adminjardin,jardin,cientifico',    'crol_describe'=>'(IxMx) Persona adscrita a un campus y que administra los datos científicos de los ejemplares.'],
            ...
            ['crol_rol'=>'consulta',                   'crol_gps'=>'amigo',                          'crol_describe'=>'Persona adscrita a un campus que puede visualizar los datos públicos de los ejemplares.'],
        ];
