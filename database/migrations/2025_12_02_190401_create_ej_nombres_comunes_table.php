...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ej_nombres_comunes', function (Blueprint $table) {
            ...
            $table->string('con_audio1')->nullable(); ##### Ruta al audio con la pronunciación
            $table->string('con_audio2')->nullable(); ##### Ruta al audio con la pronunciación
            $table->string('con_img1')->nullable(); ##### Ruta al archivo de imagen del nombre
            $table->string('con_img2')->nullable(); ##### Ruta al archivo de imagen del nombre
